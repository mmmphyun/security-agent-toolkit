...
[RPG Sync 아키텍처 포스트](/security-agent-toolkit/blog/proj-rpg-sync-project-01-problem-definition-and-architecture/)에서 디스코드를 단일 진실 공급원 SSOT로 삼고 웹 위키 및 캐싱 레이어를 구축하여 운영 비용을 절감한 기본 설계를 다루었다. 그러나 초기 시스템을 실제 운영 환경에 배포한 후 예기치 못한 운영 병목과 분산 인프라 간의 기술적 난관이 발생했다.
